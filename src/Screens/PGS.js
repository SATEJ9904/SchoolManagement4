    ...
    return (
        <View>
            ...
            <View style={{ backgroundColor: "grey", height: "100%" }}>
                ...
                >
                    <View>
                        <Text style={{ color: "black", fontSize: 35, marginTop: "15%", marginLeft: "23%" }}>Select Year :-</Text>
                        <TouchableOpacity style={{ marginTop: "45%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("SelectStudents")}>
