...
const SelectStudentsCourse = ({ navigation }) => {
    return (
        <View>
            ...
            <View style={{ backgroundColor: "blue", flexDirection: "row" }}>
                ...
                <Text style={{ fontSize: 25, color: "white", margin: "2.5%", marginLeft: "27%" }}>Select Year</Text>
            </View>
            <View style={{ backgroundColor: "grey", height: "100%" }}>
                ...
                >
                    <View>
                        ...
                        <TouchableOpacity style={{ marginTop: "35%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("SelectStudents")}>
                            <Text style={{ color: "#000", width: "200%", marginLeft: "40%", fontSize: 25, paddingVertical: 10 }}>1st YEAR</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginTop: "15%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("SelectStudents")}>
...
export default SelectStudentsCourse
