...
const ExamSelectYear = ({ navigation }) => {
    return (
        <View>
            ...
            <View style={{ backgroundColor: "grey", height: "100%" }}>
                ...
                >
                    <View>
                        ...
                        <TouchableOpacity style={{ marginTop: "35%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("ExamList")}>
