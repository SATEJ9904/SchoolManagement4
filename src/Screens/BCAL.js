            ...
            <View style={{ backgroundColor: "grey", height: "100%" }}>
                ...
                >
                    <View>
                        ...
                        <TouchableOpacity style={{ marginTop: "35%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("Lec1")}>
                            <Text style={{ color: "#000", width: "200%", marginLeft: "40%", fontSize: 25, paddingVertical: 10 }}>1st YEAR</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginTop: "15%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("Lec2")}>
                            <Text style={{ color: "#000", width: "200%", marginLeft: "40%", fontSize: 25, paddingVertical: 10 }}>2nd YEAR</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginTop: "15%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("Lec3")}>
                            <Text style={{ color: "#000", width: "200%", marginLeft: "40%", fontSize: 25, paddingVertical: 10 }}>3rd YEAR</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginTop: "15%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("Lec4")}>
