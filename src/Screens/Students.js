      ...
      <View style={{ backgroundColor: "grey", height: "100%" }}>
        ...
        >
          <View>
            ...
            <TouchableOpacity style={{ marginTop: "35%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("SelectStudentsCourse")}>
              <Text style={{ color: "#000", width: "200%", marginLeft: "45%", fontSize: 25, paddingVertical: 10 }}>BCA</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ marginTop: "15%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("SelectStudentsCourse")}>
              <Text style={{ color: "#000", width: "200%", marginLeft: "45%", fontSize: 25, paddingVertical: 10 }}>BBA</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ marginTop: "15%", marginLeft: "0%", backgroundColor: 'transparent', borderRadius: 20, borderWidth: 2, borderColor: "#000" }} onPress={() => navigation.navigate("PGS")}>
